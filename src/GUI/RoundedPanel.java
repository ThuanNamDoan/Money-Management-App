...
public class RoundedPanel extends JPanel {
    ...
    public RoundedPanel(int radius, Color shadowColor) {
        super();
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color shadowColorA = shadowColor;//new Color(shadowColor.getRed(), shadowColor.getGreen(), shadowColor.getBlue(), shadowAlpha);
